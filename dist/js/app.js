...
/***/ "./js/components/maleQuestions.js":
/*!****************************************!*\
  !*** ./js/components/maleQuestions.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nvar maleQuestions = function maleQuestions() {\n  var sex = '.male__questions ';\n  setQuestionsAnswersChoices('.first__question');\n  setQuestionsAnswerUnique('.second__question');\n\n  function setQuestionsAnswersChoices(questionNumber) {\n    var parent = sex + questionNumber;\n    var choices = document.querySelectorAll(parent + ' .choice');\n    var right_answer = document.querySelector(parent + ' .right__answer');\n    var wrong_answer = document.querySelector(parent + ' .wrong__answer');\n    choices.forEach(function (element) {\n      element.addEventListener('click', function () {\n        if (element.getAttribute('data-answer') == \"true\") {\n          right_answer.style.opacity = '1';\n          wrong_answer.style.opacity = '0';\n        } else {\n          right_answer.style.opacity = '0';\n          wrong_answer.style.opacity = '1';\n        }\n      });\n    });\n  }\n  /**\r\n   * gestion des choix et de la réponse unique (pas de bonne ou mauvaise réponse)\r\n   * @param {string} questionNumber : classname of div\r\n   */\n\n\n  function setQuestionsAnswerUnique(questionNumber) {\n    var parent = sex + questionNumber;\n    var choices = document.querySelectorAll(parent + ' .choice');\n    var answer = document.querySelector(parent + ' .answer');\n    choices.forEach(function (element) {\n      element.addEventListener('click', function () {\n        answer.style.opacity = '1';\n      });\n    });\n  }\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (maleQuestions);\n\n//# sourceURL=webpack:///./js/components/maleQuestions.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _maleQuestions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./maleQuestions */ \"./js/components/maleQuestions.js\");\n/* harmony import */ var _femaleQuestions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./femaleQuestions */ \"./js/components/femaleQuestions.js\");\n\n\n\nvar questions = function questions() {\n  btnEvent('male');\n  btnEvent('female');\n  Object(_maleQuestions__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n  Object(_femaleQuestions__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n\n  function btnEvent(sex) {\n    var btn = document.querySelector('.choose__sexe .' + sex);\n\n    if (btn) {\n      var sectionQuestions = document.querySelector('.' + sex + '__questions');\n      var sectionChoose = document.querySelector('.choose__sexe');\n      btn.addEventListener('click', function () {\n        window.currentSex = sex;\n        sectionChoose.classList.add('slideOff');\n        sectionChoose.classList.remove('slideOn');\n        sectionQuestions.classList.add('slideOn');\n      });\n    }\n  }\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (questions);\n\n//# sourceURL=webpack:///./js/components/questions.js?");
